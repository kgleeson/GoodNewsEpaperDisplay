...
def _build_image_prompt(
    ...
    return (
        ...
        f"White clothing must be STARK FLAT WHITE — no cream tinting, no warm watercolour texture, no yellow or orange shading. "
        f"Any warmth on white areas will render as olive-yellow on the display. Keep white areas pure and flat. "
        f"Grass and foliage must be bright, light-to-medium green — not deep or dark green. Dark greens go near-black on display. "
