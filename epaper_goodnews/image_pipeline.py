...
def _build_image_prompt(
    ...
    return (
        ...
        f"CRITICAL COLOUR RULE: this image will be converted to only 7 colours — black, white, red, green, blue, yellow, and orange. "
        f"Any dark tone (dark green, dark blue, dark red, dark brown, dark grey) will become BLACK regardless of its hue. "
        f"Therefore: use BRIGHT MID-TONES of every colour. No dark backgrounds, no shadowed walls, no deep-toned fills. "
        f"A blackboard or wall must be BRIGHT medium green or BRIGHT medium blue — not dark. "
        f"Sky must be bright clear blue. Grass and foliage must be bright medium green. "
        f"Avoid deep shadows, dark shading, and dark-toned large areas entirely. "
        f"Style: bold, luminous handmade watercolour in the spirit of classic children's storybooks. "
        f"Colours are saturated, rich, and vibrant — not pale or washed out, but also not dark. "
        ...
        f"White or light-coloured clothing should be clearly white or cream with minimal shading — not shaded with nearby hues. "
        f"Palette: bold and warm — strong orange, red, yellow, bright green, bright blue. "
        f"Use hue contrast between figures and background, not dark/light contrast. "
        f"Avoid dark backgrounds, muted washes, grey or dark shadows, and muddy or deeply shaded areas. "
        f"Background: fully painted and bright. Use vivid clear sky, bright green hills, warm sunshine, sea, or cheerful architectural elements. "
        f"Final image: a bold, joyful, fully-painted watercolour storybook scene using bright mid-tone colours throughout, "
        f"optimized so the 7-colour e-paper quantization preserves vivid hues rather than collapsing them to black. "
